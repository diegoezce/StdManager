...
LOGGING = {
    ...
    'formatters': {
        ...
        'detailed': {
            'format': '[{levelname}] {asctime} {name} | {funcName}:{lineno} | {pathname} - {message}',
            'style': '{',
            'datefmt': '%Y-%m-%d %H:%M:%S',
        },
        'simple': {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='BLEST <info@blestlearning.com>')
